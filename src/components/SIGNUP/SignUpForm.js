...
import styles from "./SignUpForm.module.css"; // Assuming all styles are in Signup.module.css
...
const FormActions = () => {
  ...
  const handleCreateClick = () => {
    // Add your logic to handle the creation of the account here
  ...
  const handleBackClick = () => {
    navigate('/'); // Go back to the EventHomePage as well
  };
